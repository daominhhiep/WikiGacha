...
import { useMissions, useClaimMissionReward, UserMission } from '../use-missions';
    ...
    >
      ...
      <div className="mt-auto space-y-2">
        <div className="flex justify-between items-end font-mono text-[10px] tracking-tighter">
          ...
          <span className={cn(
            "font-bold",
            isCompleted ? "text-amber-500" : "text-cyan-400"
          )}>
        ...
        <div className="h-2 w-full bg-black/60 border border-border-grid relative overflow-hidden">
          <motion.div 
            ...
            className={cn(
              "h-full relative",
              isCompleted ? "bg-amber-500" : "bg-cyan-500"
            )}
          >
    ...
    return (
      <div className="p-6 border border-red-500/50 bg-red-500/10 rounded-none flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <p className="text-red-500 font-bold font-mono">CONNECTION_ERROR: UNABLE TO FETCH MISSIONS</p>
          <p className="text-xs text-red-500/70 mt-1 uppercase">Please verify your neural link and try again.</p>
        </div>
        <Button 
          variant="outline" 
          onClick={() => refetch()} 
    ...
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex items-center justify-between mb-6 px-1">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold uppercase tracking-tight font-heading">Mission Terminal</h2>
            <p className="text-[10px] font-mono opacity-50 uppercase tracking-widest">[ SECTOR_PROGRESS_STABLE ]</p>
          </div>
        </div>
